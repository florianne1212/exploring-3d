...
void main()
{
   ...
   // strength = step(0.8, strength);
    ...
    // float lighhtX = 0.015 / distance(lightUvX, vec2(0.5));

    // vec2 lightUvY = vec2(vUv.y * 0.1 + 0.45, vUv.x * 0.5 + 0.25);
    // float lighhtY = 0.015 / distance(lightUvY, vec2(0.5));

    // float strength = lighhtX * lighhtY;
  ...
  // float strength = 1.0 - step(0.01, abs(distance(wawedUv, vec2(0.5)) - 0.25));
  ...
  // float strength = cnoise(vUv * 10.0);
    //float strength = sin(vUv.y * 50.0) * 10.0;
